      ...
      <div className="wraper">
        <div className="content">
          ...
          <div className="vertical">
            <div className="container">
              <div className="vertical__title title">
                Способы монетизации блогов
              </div>
                  ...
                  <div className="vertical__column">
                    <div className="vertical__item">
                      ...
                      <div className="vertical__text">
                        TEXT TEXT TEXT TEXT Line 155:23: The href attribute
                        requires a valid value to be accessible. Provide a
                        valid, navigable address asTEXT TEXT TEXT TEXT Line
                        155:23: The href attribute requires a valid value to be
                        accessible. Provide a valid, navigable address asTEXT
                        TEXT TEXT TEXT Line 155:23: The href attribute requires
                        a valid value to be accessible. Provide a valid,
                        navigable address asTEXT TEXT TEXT TEXT Line 155:23: The
                        href attribute requires a valid value to be accessible.
                        Provide a valid, navigable address asTEXT TEXT TEXT TEXT
                        Line 155:23: The href attribute requires a valid value
                        to be accessible. Provide a valid, navigable address
                        asTEXT TEXT TEXT TEXT Line 155:23: The href attribute
                        requires a valid value to be accessible. Provide a
                        valid, navigable address as the href value. If you
                        cannot provide a valid href, but still need the element
                        to resemble a link, use a button and change it with
                        appropriate styles. Learn more:
                      </div>
                      <a href="#" className="vertical__btn">
                        BUTTON
                      </a>
                    </div>
                  </div>
